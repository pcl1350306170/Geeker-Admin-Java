...
INSERT INTO `sys_job` (`id`, `job_name`, `job_group`, `invoke_target`, `cron_expression`, `concurrent`, `status`, `remark`, `create_time`, `update_time`) VALUES (1,'清理历史系统日志','DEFAULT','sampleTask.cleanExpiredLog(30)','0 0 3 * * ?',1,0,'每天凌晨3点清理30天前的系统日志（默认暂停，可手动启用）','2026-09-18 00:00:00','2026-09-18 00:00:00'),(2,'统计开发资产总数','DEFAULT','sampleTask.countDevAsset()','0 0/30 * * * ?',1,0,'每30分钟统计一次开发资产总数并打印（演示用，默认暂停）','2026-09-18 00:00:00','2026-09-18 00:00:00'),(3,'演示-带参任务','DEFAULT','sampleTask.showMessage(''定时任务运行中'')','0/30 * * * * ?',1,0,'每30秒打印一次消息（演示用，默认暂停）','2026-09-18 00:00:00','2026-09-18 00:00:00');
